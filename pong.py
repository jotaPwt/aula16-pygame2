...
velocidade_bola_x, velocidade_bola_y = 4, 
...
#   pontos_textos = fonte.render(f'{pontos_player1} - {pontos_player2}', True, preto)
#   janela.blit(pontos_textos, (200, 200))


# def reiniciar_bola():
#   global bola_x_x, bola_y_y, velocidade_bola_x, velocidade_bola_y
#   bola_x, bola_y = 250, 250
...
#     if bola_y <= 0 or bola_y >= 500 - bola.get_height():
#       velocidade_bola = - velocidade_bola
#     if (bola_x <= raquete1_x + raquete_largura and bola_x > raquete1_x and bola.get_height() > raquete1_y and bola_y < raquete1_y + raquete_altura):
#       velocidade_bola_x =- velocidade_bola_x
#     if (bola_x <= raquete1_x + raquete_largura and bola_x > raquete1_x and bola.get_height() > raquete2_y and bola_y < raquete2_y + raquete_altura):
#       velocidade_bola_x =- velocidade_bola_x
#     if bola_x <= 0:
#       pontos_player2 += 1
#       reiniciar_bola()
#     elif bola_x >= 500 - bola.get_width():
#       pontos_player1 += 1
#       reiniciar_bola()
...
# raquete1_x, raquete2_y = 50, 225

# raquete2_x, raquete2_y = 350, 225